...
namespace StudentManagementApp.Tests.TestCases
{
    public class FunctionalTests
    {
        ...
        [Fact]
        public async Task<bool> Testfor_Get_Student()
        {
            //Arrange
            var res = false;
            ...
            try
            {
                  studentservice.Setup(repos => repos.GetAllStudents()).Returns(StudentList);
        ...
        [Fact]
        public async Task<bool> Testfor_Get_Student_ById()
        {
            //Arrange
            var res = false;
            string testName; string status;
        ...
        public async Task<bool> Testfor_Delete_Budget()
        {
            ...
            try
            {
                 studentservice.Setup(repos => repos.DeleteStudent(_Student.StudentId)).Returns(_Student);
                var result= _studentService.DeleteStudent(_Student.StudentId);
